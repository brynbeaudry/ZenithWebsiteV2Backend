    ...
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Activities", x => x.ActivityCategoryId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    EventId = table.Column<int>(nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    ActivityCategory = table.Column<int>(nullable: false),
                    CreationDate = table.Column<DateTime>(nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Events_Activities_ActivityCategory",
                        column: x => x.ActivityCategory,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Events_ActivityCategory",
                table: "Events",
